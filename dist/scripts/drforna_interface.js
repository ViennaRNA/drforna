(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["drforna_interface"] = factory();
	else
		root["drforna_interface"] = factory();
})(this, function() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _drforna = __webpack_require__(1);
	...
	(0, _jquery2.default)(document).ready(function () {
	    ...
	    */
	    ...
	    function createNewPlot(file) {
	        var data = _d2.default.dsv(' ').parse(file.target.result);

	        var currentCTView = 'time-series';
	        var width = 800;
	        var height = 600;

	        var currentLayout = (0, _drforna.cotranscriptionalTimeSeriesLayout)();

	        var showPlot = function showPlot(plotLayout) {
	        ...
	        var showTimeSeriesPlot = function showTimeSeriesPlot() {
	            showPlot(currentLayout.newTimePointCallback(function (d) {}).newTimeClickCallback(function (d) {}));

	            if (toggleView == showTimeSeriesPlot) toggleView = showSmallMultiplesPlot;else toggleView = showTimeSeriesPlot;
	        };

	        var showSmallMultiplesPlot = function showSmallMultiplesPlot() {
	            showPlot((0, _drforna.cotranscriptionalSmallMultiplesLayout)().width(800));
	        ...
	        function setLayoutSize(layout) {
	            ...
	            var svgH = window.innerHeight - 40;

	            currentLayout.width(svgW).height(svgH);
	    ...
	    (0, _jquery2.default)('#files').on('change', function (evt) {
	    ...
	    _jquery2.default.get('data/pete.result', function (result) {
	        var file = { target: {} };
	...
	function combineDotAndStruct() {
	    ...
	    var gMiddle = _d2.default.select('#middle-layer');
	    var gRoot = _d2.default.select('#root-g');

	    if (gMiddle.attr('transform') == 'translate(0,0)') gMiddle.transition().attr('transform', 'translate(' + gRoot.node().getBBox().width + ',0)').attr('opacity', 1.0);else gMiddle.transition().attr('transform', 'translate(0,0)').attr('opacity', 0.4);
	}
